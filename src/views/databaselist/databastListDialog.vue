      ...
      <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" label-width="120px" class="demo-ruleForm"
        ...
        <el-form-item label="被他人使用">
          <el-radio-group v-model="ruleForm.isshow">
            <el-radio style="width:100%" :label="1" size="large">允许所有老师使用</el-radio>
            <el-radio style="width:100%" :label="2" size="large">不允许任何老师使用</el-radio>
            <el-radio style="width:100%" :label="3" size="large" @click="teachersDialogFn">允许部分老师使用</el-radio>
          </el-radio-group>
          <span class="teachersNum" v-if="ruleForm.isshow === 3">{{ teachersNum }}</span>
        </el-form-item>
      </el-form>
