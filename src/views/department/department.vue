  ...
  <div class="department">
    ...
    <div class="right" v-if="childFlag">
      ...
      <div class="fatherChild" v-if="childFlag === 2">
        <el-form ref="fatherRuleFormRef" :model="fatherRuleForm" :rules="fatherRules" class="demo-ruleForm" status-icon>
      ...
      <div class="sonChild" v-else="childFlag===1">
        <div class="my">当前节点: <span>{{ nowChild.name }}</span> </div>
        <el-form ref="sonRuleFormRef" :model="sonRuleForm" :rules="sonRules" class="demo-ruleForm" status-icon>
          <el-form-item label="节点名称" prop="name">
        ...
        <div class="button">
          ...
          <el-button type="success" @click="sonUpdate(1)">修改当前节点</el-button>
...
// 添加一级节点
const addChild = () => {
  fatherRuleFormRef.value.validate((valid: boolean) => {
    console.log(valid);
    if (valid) {
      console.log('submit!')
    } else {
